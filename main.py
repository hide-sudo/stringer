...
BOT_TOKEN = os.getenv("")  # Environment variable se token le raha hai #Your bot token 
CHANNEL_1_USERNAME = "its_deva_here"  # First channel username
CHANNEL_2_USERNAME = "Matlabi_Duniyah"  # Second channel username
...
async def start_message(client, message):
    ...
    join_button_1 = InlineKeyboardButton("˹sυᴘᴘσꝛᴛ˼", url="https://t.me/its_deva_here")
    join_button_2 = InlineKeyboardButton("˹ᴧʟʟ ʙσᴛ˼", url="https://t.me/Matlabi_Duniyah")
